...
# for swagger.Taxon objects
    ...
    #' @family swagger.TaxonClient-wrappers
    #' @return scalar
    ...
    #' @param ... additional parameters passed to count from class swagger.TaxonClient
    #' @export
    ...
    #' @param ... additional parameters passed to count_distinct_values from class swagger.TaxonClient
    #' @export
    ...
    #' @param field name of field in the taxon object, type: 
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to count_distinct_values_per_group from class swagger.TaxonClient
    #' @export
    ...
    #' @param sourceSystem.code Example query param, type: 
    #' @param queryParams Named list or vector with names being the fields to be queried and values being the values to match
    #' @param ... additional parameters passed to download_query from class swagger.TaxonClient
    #' @export
    ...
    #' @param ... additional parameters passed to dwca_get_data_set from class swagger.TaxonClient
    #' @export
    ...
    #' @return scalar
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to dwca_get_data_set_names from class swagger.TaxonClient
    #' @export
    ...
    #' @param sourceSystem.code Example query param, type: 
    #' @param queryParams Named list or vector with names being the fields to be queried and values being the values to match
    #' @param ... additional parameters passed to dwca_query from class swagger.TaxonClient
    #' @export
    ...
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to find from class swagger.TaxonClient
    #' @export
    taxon_find <- function(
        id = NULL,
        returnType='data.frame',
    ...
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to find_by_ids from class swagger.TaxonClient
    #' @export
    ...
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to get_distinct_values from class swagger.TaxonClient
    #' @export
    ...
    #' @param field name of field in the taxon object, type: 
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to get_distinct_values_per_group from class swagger.TaxonClient
    #' @export
    ...
    #' @return scalar
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to get_field_info from class swagger.TaxonClient
    #' @export
    ...
    #' @return scalar
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to get_paths from class swagger.TaxonClient
    #' @export
    ...
    #' @return scalar
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to get_settings from class swagger.TaxonClient
    #' @export
    ...
    #' @param queryParams Named list or vector with names being the fields to be queried and values being the values to match
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to group_by_scientific_name from class swagger.TaxonClient
    #' @export
    ...
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to is_operator_allowed from class swagger.TaxonClient
    #' @export
    ...
    #' @param queryParams Named list or vector with names being the fields to be queried and values being the values to match
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to query from class swagger.TaxonClient
    #' @export
