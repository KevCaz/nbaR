...
# for swagger.Geo objects
    ...
    #' @param ... additional parameters passed to count_distinct_values from class swagger.GeoClient
    #' @export
    ...
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to count_distinct_values_per_group from class swagger.GeoClient
    #' @export
    ...
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to find from class swagger.GeoClient
    #' @export
    geo_find <- function(
        id = NULL,
        returnType='data.frame',
    ...
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to find_by_ids from class swagger.GeoClient
    #' @export
    ...
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to get_distinct_values from class swagger.GeoClient
    #' @export
    ...
    #' @param field name of field in the geo area object, type: 
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to get_distinct_values_per_group from class swagger.GeoClient
    #' @export
    ...
    #' @return scalar
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to get_field_info from class swagger.GeoClient
    #' @export
    ...
    #' @return scalar
    #' @param locality , type: 
    #' @param ... additional parameters passed to get_geo_json_for_locality from class swagger.GeoClient
    #' @export
    ...
    #' @return scalar
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to get_paths from class swagger.GeoClient
    #' @export
    ...
    #' @param ... additional parameters passed to get_setting from class swagger.GeoClient
    #' @export
    ...
    #' @return scalar
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to get_settings from class swagger.GeoClient
    #' @export
    ...
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to is_operator_allowed from class swagger.GeoClient
    #' @export
    ...
    #' @param queryParams Named list or vector with names being the fields to be queried and values being the values to match
    #' @param returnType Either \code{list} or \code{data.frame} (default)
    #' @param ... additional parameters passed to query from class swagger.GeoClient
    #' @export
    geo_query <- function(
      queryParams = list(),
        returnType='data.frame',
