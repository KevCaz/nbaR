...
#' @section Methods:
#' \describe{
#' \item{\code{ count_distinct_values_http_get }}{
#'
...
#' }
#' \item{\code{ count_distinct_values_http_json }}{
#'
#'   Count the distinct number of values that exist for a given field;
#'   Field given as string. See also getDistinctValues.
#'
...
#'     \itemize{
#'         
#'         \item \code{ field } : name of field in the geo area object 
#'         
#'         
#'         \item \code{ ... } : additional parameters passed to httr::GET
#'     }
...
#'         \code{ TODO_OBJECT_MAPPING }
#' }
#' \item{\code{ count_distinct_values_per_group_http_get }}{
#'
...
#'         \code{ TODO_OBJECT_MAPPING }
#' }
#' \item{\code{ count_distinct_values_per_group_http_post_json }}{
#'
#'   Count the distinct number of field values that exist per the given field to group by;
#'   See also endpoint /getDistinctValues. See also getDistinctValuesPerGroup.
#'
...
#'         \code{ Integer }
#' }
#' \item{\code{ count_http_post_json }}{
#'
#'   Get the number of geo areas matching a given condition;
...
#'         \code{ GeoArea }
#' }
#' \item{\code{ get_distinct_values_http_get }}{
#'
...
#'         \code{ TODO_OBJECT_MAPPING }
#' }
#' \item{\code{ get_distinct_values_http_post_json }}{
#'
#'   Get all different values that exist for a field;
#'   A list of all fields for geo area documents can be retrieved with /metadata/getFieldInfo.
#'
...
#'     \itemize{
#'         
#'         \item \code{ field } : name of field in a geo area object 
#'         
#'         
#'         \item \code{ ... } : additional parameters passed to httr::GET
#'     }
...
#'         \code{ TODO_OBJECT_MAPPING }
#' }
#' \item{\code{ get_distinct_values_per_group_http_get }}{
#'
#'   Get all distinct values (and their document count) for the field given divided per distinct value of the field to group by;
#'   See also endpoint /getDistinctValues.
#'
...
#'         \code{ QueryResult }
#' }
#' \item{\code{ query_http_post_json }}{
#'
#'   Query for geo areas;
#'   Query on searchable fields to retrieve matching geo areas.
#'
#'     Parameters:
#'     \itemize{
#'         \item \code{ locality } : Example query param 
#'         
#'         \item \code{ queryParams } : named list or vector with query parameters 
#'         
#'         \item \code{ ... } : additional parameters passed to httr::GET
...
GeoApi <- R6::R6Class(
    ...
    public = list(
      ...
      count_distinct_values_http_get = function(
          field = NULL,
          ... ) {
      ...
      count_distinct_values_http_json = function(
          field = NULL,
          body = NULL,
          ... ) {
        headerParams <- character()
      ...
      count_distinct_values_per_group_http_get = function(
          group = NULL,
          field = NULL,
          ... ) {
        headerParams <- character()
      ...
      count_distinct_values_per_group_http_post_json = function(
          group = NULL,
          field = NULL,
          body = NULL,
          ... ) {
      ...
      get_distinct_values_http_get = function(
          field = NULL,
          ... ) {
        headerParams <- character()
        queryParams <- list()
      ...
      get_distinct_values_http_post_json = function(
          field = NULL,
          body = NULL,
          ... ) {
        headerParams <- character()
      ...
      get_distinct_values_per_group_http_get = function(
          group = NULL,
          field = NULL,
          ... ) {
        headerParams <- character()
      ...
      get_geo_json_for_locality = function(
        ...
        if (httr::status_code(response) < 200 ||
            ...
            ## API call result is object of model class
            returnObject <- GeoJsonObject$new()
            ## if API call result is QueryResult,
            ## list items must be mapped to model class            
            result <- returnObject$fromList(
                httr::content(response),
      ...
      query_http_post_json = function(
        ...
        if (!missing(`locality`)) {
          ## querySpec can be either JSON string or object of type QuerySpec. 
          param <- ifelse(typeof(`locality`) == "environment",
                          `locality`$toJSONString(),
                          `locality`)    
    ...
    print = function(...) {
       ...
       ## print all methods
       cat("Methods:\n")
           cat("\tcount_distinct_values_http_get", "\n")
           cat("\tcount_distinct_values_http_json", "\n")
           cat("\tcount_distinct_values_per_group_http_get", "\n")
           cat("\tcount_distinct_values_per_group_http_post_json", "\n")
           cat("\tcount_http_get", "\n")
           cat("\tcount_http_post_json", "\n")
           cat("\tfind1", "\n")
           cat("\tfind_by_ids1", "\n")
           cat("\tget_distinct_values_http_get", "\n")
           cat("\tget_distinct_values_http_post_json", "\n")
           cat("\tget_distinct_values_per_group", "\n")
           cat("\tget_distinct_values_per_group_http_get", "\n")
           cat("\tget_field_info", "\n")
