  ...
  public = list(
    ...
    `sourceSystem`,
      ...
      if (!missing(`phaseOrStage`)) {
        stopifnot(is.character(`phaseOrStage`),
      ...
      if (!missing(`preparationType`)) {
        stopifnot(is.character(`preparationType`),
      ...
      if (!missing(`numberOfSpecimen`)) {
        stopifnot(is.numeric(`numberOfSpecimen`),
      ...
      if (!missing(`associatedMultiMediaUris`)) {
        stopifnot(is.list(`associatedMultiMediaUris`),
                  length(`associatedMultiMediaUris`) != 0)
        lapply(`associatedMultiMediaUris`,
               function(x) stopifnot(R6::is.R6(x)))
        ## omit names as they should not be part of JSON representation
      ...
      if (!missing(`associatedMultiMediaObjects`)) {
        stopifnot(is.list(`associatedMultiMediaObjects`),
                  length(`associatedMultiMediaObjects`) != 0)
        lapply(`associatedMultiMediaObjects`,
               function(x) stopifnot(R6::is.R6(x)))
        ## omit names as they should not be part of JSON representation
    ...
    fromList = function(SpecimenList,
      ...
      self[["associatedMultiMediaUris"]] <- lapply(SpecimenList[["associatedMultiMediaUris"]],
            ...
            self[["theme"]] <-
                SpecimenList[["theme"]]        
      self[["associatedMultiMediaObjects"]] <- lapply(SpecimenList[["associatedMultiMediaObjects"]],
                                       function(x){
